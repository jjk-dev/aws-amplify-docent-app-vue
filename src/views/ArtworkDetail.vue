<template>
  <div class="artworkDetail">
    <div class="container">
      ...
      <b-row no-gutters>
        <b-col md="5" >
          <b-card-img :src="`${pic.img}`" :alt="`${pic.title}`" ></b-card-img>
        </b-col>
        <b-col md="1"><b-card-text></b-card-text></b-col>
        <b-col md="6">
          <b-card-text>
          <h2 class="title"><strong>{{ pic.title }}</strong></h2>
            <p class="subtitle">{{ pic.author }}</p>
            <p class="description"><strong>작품 종류 | </strong> {{ pic.type }}</p>
            <p class="description"><strong>작품 설명 |</strong></p>
            <p>{{ pic.description }}</p>
            <p class="description"><strong>작품 위치 | </strong> {{ pic.location }}</p>
        </b-card-text>
        </b-col>
      </b-row>
    </b-card>
...
export default {
  ...
  created() {
    ...
    let pic = this.pics.find(pic => pic.id === ID);
    this.pic = pic;
  }
}
</script>
